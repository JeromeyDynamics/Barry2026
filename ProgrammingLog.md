...
### _"Initial commit"_ (`60bd6ea6538e3b1dcbd25c46f91b1941eb89246f`) ⭐
...
### _"added a file for build logging and started the readme"_ (`e837ba7886294051d24e539ade23f12996c71d27`)
...
### _"added images to build log and read me files"_ (`7c68983596f9cebfb0dd0e94aae93f63ac564fe8`)
...
### _"uncommented lines 39-42 on build.gradle for optimization for roborio2"_ (`2579c71fd1fd16c138358bfaa3dfe2d1558a784a`)
...
### _"fixed image not showing in readme"_ (`2bffacf157bccd4eb7551c6bb27ed17d175657c3`)
...
### _"added the starting cad files in the code as well as the code to add components smoothly"_ (`74c4ea2fa9c79f0d359cc6cb0dd42e32fb8012f0`)
...
### _"put offsets so that the intake is in the right place on the robot base in advantage scope"_ (`69db6094bb237a067d8937cbf193d9fbc4fd2fd3`)
...
### _"redid the config cad constants to work now"_ (`8db4e24dda56cbb4d3a45f3dc335f357107a5b1d`)
...
### _"Added intial intake code"_ (`a39adf890fa6d12aec6a211354d433507560fff7`) ⭐
...
### _"added simple PIDs (not fully tuned) for the intake and now it works in simulation"_ (`667e5301fbde0b47432aa0cee86b41e827b5c09b`) ⭐
...
### _"fixed readme links"_ (`fb5e77a400a6a55330596f96f47b942429dedac8`) ⭐
**Goal:** The links on the ReadMe need to be fixed  
**Process:** added ./ in front of the file links (ex: ./cad/BuildLog.md)